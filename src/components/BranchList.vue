...
<template>
  <div class="bg-white shadow rounded-lg">
    <header
      class="px-4 py-5 sm:p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0 mb-4"
    >
      ...
      <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
        <button
          ...
          class="flex items-center justify-center px-4 py-2 border text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-colors gap-2 cursor-pointer w-full sm:w-auto"
        >
        ...
        <button
          ...
          class="flex items-center justify-center px-4 py-2 border text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors gap-2 cursor-pointer w-full sm:w-auto"
